...
# "default" backs FileField/ImageField (receipt uploads). Overriding STORAGES without it
# removes Django's default file storage and every upload fails at runtime.
STORAGES = {
