...
export default function SettingsScreen() {
  ...
  function confirmSignOut() { Alert.alert('Sign out?', 'You will need your email and password to reconnect this device.', [{ text: 'Cancel', style: 'cancel' }, { text: 'Sign out', style: 'destructive', onPress: () => void signOut() }]); }
  return <SafeAreaView style={styles.container}><SyncStatusBar /><ScrollView contentContainerStyle={styles.content}><Text style={styles.title}>Settings</Text><Text style={styles.subtitle}>{activeGroup?.name}</Text>
    ...
    <Text style={styles.version}>Today Meal Offline · v2.0.1</Text></ScrollView></SafeAreaView>;
}
