    ...
    await execute(
      `INSERT OR REPLACE INTO expenses
        (id, group_id, month, date, spent_by, meal_manager_name, assistant_meal_manager_name,
         ...
         total_daily_expense, cost_per_meal, created_by_name, updated_by_id, updated_by_name,
         version, client_operation_id, deleted_at, deleted_by, created_date, updated_date)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
        expense.id,
        expense.group_id,
